...
name: adapt-legacy
description: >-
  Legacy Caduceus-ready prep (CDS±10kb, neighbour trim, non-coding, TPM) via
  src/preprocessing.py → data_ready/. Former @adapt; use @adapt for MARKED/intersect.
...
> **Legacy skill.** Canonical Caduceus panel builder. New marking stage: `@adapt` → `src/pipeline/adapt.py`.
