...
def setup_logger(
    ...
    if log_dir is not None:
        ...
        try:
            ...
            print(
                f"Предупреждение: не удалось создать директорию логов {log_dir}: {e}",
                file=sys.stderr,
            )
            log_dir = None
    ...
    if log_dir is not None:
        ...
        try:
            ...
            print(
                f"Предупреждение: не удалось создать файл лога {log_file}: {e}",
                file=sys.stderr,
            )
        ...
        try:
            ...
            print(
                f"Предупреждение: не удалось создать файл лога ошибок {error_file}: {e}",
                file=sys.stderr,
            )
