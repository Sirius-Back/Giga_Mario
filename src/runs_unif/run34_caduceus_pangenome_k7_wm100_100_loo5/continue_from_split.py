"""Continue run34: reuse run33 LOO5 tables → Caduceus direct LOO + adversarial.

Source: ``runs_unif/legnet/run33_legnet_pangenome_k7_wm100_100_loo5``
Out: ``runs_unif/caduceus/run34_caduceus_pangenome_k7_wm100_100_loo5``

Launch::

  conda run -n caduceus_env --no-capture-output \\
    python -m src.runs_unif.run34_caduceus_pangenome_k7_wm100_100_loo5.continue_from_split
"""
...
SOURCE_UNIF = ROOT / "runs_unif" / "legnet" / "run33_legnet_pangenome_k7_wm100_100_loo5"
...
def stage_split() -> dict:
    ...
    append_queue_entry(
        ...
        job_class=CLASS_CPU_RAM_HEAVY,
        peak_ram_gib=PEAK_RAM_GIB_STAGE,
        resources="rematerialize run33 LOO folds on ready_caduceus",
