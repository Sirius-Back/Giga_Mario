# Do Execution Report Template

Final (and optionally mid-run cumulative) report for `@do`.
...
| Field | Value |
|-------|-------|
| Last checkpoint | docs/do-checkpoint.md |
| Timestamp | … |
| Last completed wave | 2 |
| Resume command | `@do` (resumes from checkpoint) |
